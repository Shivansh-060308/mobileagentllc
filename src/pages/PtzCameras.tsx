...
export default function PtzCameras() {
  return (
        ...
        <div className="container px-4">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-4">PTZ Cameras</h1>
              <p className="text-lg text-muted-foreground mb-6">
                Pan-Tilt-Zoom cameras for comprehensive coverage of large areas. 
                With auto-tracking and remote control, monitor warehouses, parking lots, and commercial properties with precision.
              </p>
